...
namespace ffDevelopmentSpace
{
    ...
    public class GameManagerController : SingletonMB<GameManagerController>
    {
        ...
        public bool AddHttpWebManagerControoler = true;
        ...
        private void Init()
        {
            ...
            if (AddHttpWebManagerControoler) this.gameObject.AddComponent<HttpWebManagerControoler>();
            ...
            ModuleManager.GetInstance().CreateModule("Login");
